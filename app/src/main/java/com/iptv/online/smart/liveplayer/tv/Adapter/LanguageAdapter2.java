...
/**
 * Language screen 2 no adapter (GpsTracker LanguageAdapter2 jevu).
 * LanguageAdapter ni exact copy chhe, alag class rakhi jethi screen 2 nu
 * behaviour/design future ma independent-ly change kari sakay.
 */
public class LanguageAdapter2 extends RecyclerView.Adapter<LanguageAdapter2.MyViewHolder> {
    Context context;
    ...
    public LanguageAdapter2(List<LanguageModel> list, Context context, String languageCode, boolean isFromSettings, OnClickItemListener onClickItemListener) {
